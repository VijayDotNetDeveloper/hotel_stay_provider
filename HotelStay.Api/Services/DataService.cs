...
{
    private readonly List<ReservationRecord> _reservations = new();
    ...
    {
        new("PREM-101", "Premier Ocean View", "Seattle", RoomType.Suite, 329m, CancellationPolicy.Flexible, new[] { "Pool", "Breakfast", "WiFi" }, 5),
        new("PREM-102", "Premier City Loft", "New York", RoomType.Deluxe, 249m, CancellationPolicy.Limited, new[] { "Gym", "WiFi" }, 4),
        new("PREM-103", "Premier Harbor Stay", "Paris", RoomType.Standard, 189m, CancellationPolicy.Flexible, new[] { "WiFi", "Breakfast" }, 4),
    ...
    {
        "{\"hotel_id\":\"BUD-201\",\"hotel_name\":\"Budget Nest Downtown\",\"destination\":\"Seattle\",\"room_type\":\"Standard\",\"rate_per_night\":89.00,\"cancellation_policy\":\"Limited\",\"available\":true}",
        ...
        "{\"hotel_id\":\"BUD-203\",\"hotel_name\":\"Budget Nest Central\",\"destination\":\"Paris\",\"room_type\":\"Standard\",\"rate_per_night\":99.00,\"cancellation_policy\":\"Limited\",\"available\":true}",
        "{\"hotel_id\":\"BUD-204\",\"hotel_name\":\"Budget Nest Express\",\"destination\":\"Tokyo\",\"room_type\":\"Suite\",\"rate_per_night\":179.00,\"cancellation_policy\":\"Limited\",\"available\":true}",
    ...
    {
        _reservations.Add(record);
    }

    public ReservationRecord? GetReservation(string reference)
    {
        return _reservations.FirstOrDefault(r => string.Equals(r.Reference, reference, StringComparison.OrdinalIgnoreCase));
    }
